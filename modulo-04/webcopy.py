...
save_webpage(
    ...
    **kwargs
    ...
    # Dessa forma, ao escrever uma função, vocẽ não precisa definir quantos argumentos serão passados para sua função.
# O **kwargs possibilita verificarmos os parãmetros nomeados da função, isto é, aqueles parãmetros que são passados com um nome!
