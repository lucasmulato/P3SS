...
#UNICODE CORRESPONDE LETRAS E NUMEROS, NÃO SÓ CODIGOS DE 0 A 127

#Em vez de usar os códigos de 0 a 127, o UNICODE utiliza códigos de valor bem maiores. Com isso, pode representar todos os caracteres especificos
#de diversos idiomas.
#Novos códigos são regularmente atribuídos para novos caracteres, como caracteres latinos (acentuados ou não), gregos, cirílicos, armênios, hebaicos,
...
#Mas vocẽ ja reparou que não há caracteres acentuados? Pois é, os americanos não pensaram no resto do mundo.
...
#Por padrão, o encode()método não requer nenhum parãmetro. 

#Ele retorna uma versão codificada em utf-8 da string. Em caso de falha, ele gera uma UnicodeDecodeErrorexecção.

#No entando, são necessários dois parâmetros:
