...
#Para deixar claro que o ponto deve ser literamente e não qualquer caractere.
#Para deixar claro que o ponto deve ser apenas, é preciso escapar o caractere com \. Assim temos:
...
# Adicionamos duas colunas a mais, para qua a correspondência bata exatamente com os endereçõs IP
...
# A quantidadede vezes que essa classe de caracteres deve aparecer é definida por um quantifier
