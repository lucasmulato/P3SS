...
if var <= 5:
    print('O valor da variavel é menor ou igual a 5')

#and    Retorna True se amas as afirmações forem verdadeiras
#or Retorna True se uma das afirmações for verdadeiras
...
# Se o número 1 for maior que 4 ou numero 2 menor ou igual a 8
# Exemplo or
if num1 > 4 or num2 <= 8:
    print("Uma ou duas das condições são verdadeiras")

# Se o numero1 não for maior que 8 e o numero2 não for menor que 8
# Exemplo not
if not (num1 > 8 and num2 < 8 ):
    print('Uma das condiçoes é falsa')