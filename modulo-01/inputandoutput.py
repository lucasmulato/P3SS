...
# Criamos ma váriavel chamado Hello com um texto Hello World
#hello = 'Hello World
#print(hello)

#Criando uma variavel com um Input que pede para digitarmos o Hello World
...
#num1 = input("Digite algum número: ") #Abri a variavel num1 e num2 que está esperando algum valor
#num2 = input("Digite algum número: ")

#resultado = (num1 - num2) #Aqui está a variavel resultado fazendo a subtração dos valores correspondente da variavel num1 - num2
#print("O resultado da soma e", resultado) #Aqui é o resultado da soma
