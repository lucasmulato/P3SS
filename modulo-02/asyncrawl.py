...
async def download_file(url):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        return content
#Nessa etapa ele vai ler o conteúdo do arquivo criado com o nome async_{name} e vai abrir o arquivo em modo binario assim ele não altera os dados conforme são gravados
...
#Aqui será as tarefas que ele vai executar com o arquivo
