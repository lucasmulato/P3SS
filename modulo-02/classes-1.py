#Ele é executado assim que um objeto de uma classe é instanciado. O método é util para fazer
...
class Dog:
    ...
    # A simple class
    # Vamos criar dois atributos com nome dos cachorros
    attr1 = "spike"
    attr2 = "bob"
...
# e método através de ojetos, passando a função fun com o objeto Dog
print(namedog.attr1)
print(namedog.attr2)
namedog.fun()
