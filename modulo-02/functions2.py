...
def calcular_pagamento(qtd_horas, valor_hora):
    ...
    if horas <= 40:
        salario = horas*taxa #Se as horas for igual ou menor que 40 ele abre a variavel salario ao qual o calculo de vezes das horas e taxas
    else:
...
#Agora vamos utilizar essa função para entrar com os valores e imprimir na tela posteriormente
str_horas = input('Digite as horas: ') #Informações que serão armazenadas em strings
str_taxa = input('Digite a taxa: ')
total_salario = calcular_pagamento(str_horas,str_taxa) #Em seguida obtemos o resultado da função e o atribuimos à variavel total_salario
